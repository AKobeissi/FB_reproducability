...
from ..experiments import RAGExperiment
...
def parse_args():
    ...
    cwd = Path.cwd()
    default_vector_store_dir = str((cwd / "vector_stores").resolve())
    default_output_dir = str((cwd / "outputs").resolve())
...
def main():
    ...
    pdf_dir = args.pdf_dir or str((Path.cwd() / "pdfs").resolve())
